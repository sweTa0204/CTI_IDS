#!/usr/bin/env python3
"""
Generate Separate High-Resolution Images for Random Forest Model
================================================================
...
ax.set_title('Random Forest - Confusion Matrix', fontsize=16, fontweight='bold', pad=15)
plt.tight_layout()
...
ax.plot(fpr, tpr, 'forestgreen', linewidth=2.5, label=f'Random Forest (AUC = {metrics["roc_auc"]:.4f})')
ax.plot([0, 1], [0, 1], 'k--', linewidth=1.5, label='Random Classifier')
ax.fill_between(fpr, tpr, alpha=0.3, color='forestgreen')
ax.set_xlabel('False Positive Rate', fontsize=14)
ax.set_ylabel('True Positive Rate', fontsize=14)
ax.set_title('Random Forest - ROC Curve', fontsize=16, fontweight='bold', pad=15)
...
bars = ax.barh(importance_df['Feature'], importance_df['Importance'], color='forestgreen', edgecolor='darkgreen')
...
ax.set_title('Random Forest - Performance Metrics', fontsize=16, fontweight='bold', pad=15)
ax.set_ylim([0, 110])
