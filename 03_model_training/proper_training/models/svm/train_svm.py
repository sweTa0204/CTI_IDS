"""
Support Vector Machine (SVM) Model Training Script for DoS Attack Detection
============================================================================

This script trains an SVM classifier with RBF kernel for binary classification
...
MODEL_OUTPUT = "svm_model.pkl"
RESULTS_OUTPUT = "../../results/svm_results.json"

# ============================================================
# LOAD DATA
# ============================================================
print("=" * 60)
print("SVM Model Training for DoS Detection")
print("=" * 60)
...
# ============================================================
print("\n[2/4] Initializing SVM model...")
print(f"      Parameters:")
print(f"        - kernel: {KERNEL}")
print(f"        - C: {C}")
print(f"        - gamma: {GAMMA}")
print(f"        - probability: True (for predict_proba)")
...
print("      (Note: SVM can be slow on large datasets)")
...
print(f"        - Class 0 (Normal): {model.n_support_[0]:,}")
print(f"        - Class 1 (DoS): {model.n_support_[1]:,}")
...
results = {
    ...
    "support_vectors": {
        ...
        "class_0": int(model.n_support_[0]),
        "class_1": int(model.n_support_[1])
    }
}
